...
Every person has heard at least once about programming languages like C (or C++), BASIC, Java... They are present in almost every application. But Haskell, who knows it? It's a pity, but only a few people know about it. 
...
However, in spite of all the advantages mentioned above, it's very enjoyable to write programs in Haskell language. Defining new types and data constructors will rise your horizones. Card games, trees, etc., everything can be written in Haskell.
